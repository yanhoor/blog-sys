      ...
      <view class="content-container">
        ...
        >
          ...
          <uni-forms-item label="性别" name="gender">
            <radio-group @change="editForm.gender = $event.detail.value">
              <view class="radio-container">
                <label>
                  <radio :value="0" :checked="editForm.gender == 0" /><text
                    >未设置</text
                  >
                </label>
                <label>
                  <radio :value="1" :checked="editForm.gender == 1" /><text
                    >男</text
                  >
                </label>
                <label>
                  <radio :value="2" :checked="editForm.gender == 2" /><text
                    >女</text
                  >
                </label>
              </view>
          ...
          <uni-forms-item label="头像" name="avatar">
            <YUploadImg v-model="editForm.avatar" />
          </uni-forms-item>
          <uni-forms-item label="资料卡背景" name="profileCardBg">
            <YUploadImg v-model="editForm.profileCardBg" />
          </uni-forms-item>
        </uni-forms>
...
export default {
  ...
  created() {
    ...
    this.editForm.birthday = this.myInfo.birthday
      ? new Date(this.myInfo.birthday)
      : ''
  },
  methods: {
