<template>
  <view class="comment-item">
    <view class="comment-left">
      <UserAvatar :user="comment.createBy" :size="36" />
    </view>
    <view class="comment-right">
      ...
      <YExpandanleContent
        ...
        @tap="$emit('showReply', comment)"
      />
      <view class="comment-bottom">
        <YTime class="item-time" type="format" :time="comment.createdAt" />
        <uni-icons
          class="action-icon"
          type="more-filled"
          size="20"
      ...
      <view v-if="comment.childComments.length" class="comment-reply-container">
        <view
        ...
        >
          <UserName :user="reply.createBy" :text="'@' + reply.createBy.name" />
        ...
        >
          ...
          <uni-icons type="bottom" size="18" color="#18a058" />
        </view>
      </view>
    </view>
  </view>
  <uni-popup ref="menuPopupRef" type="bottom" background-color="#fff">
    <uni-list class="menu-list">
      <uni-list-item
        v-if="comment.createById === myInfo?.id"
        clickable
